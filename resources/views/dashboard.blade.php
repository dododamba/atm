                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-6">
                        <div class="dashboard-stat color-1">
                            ...
                            <div class="dashboard-stat-item"><p>{{ strftime('%d %B %Y, %H:%M') }}</p></div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-6">
                        <div class="dashboard-stat color-2">
                            ...
                            <div class="dashboard-stat-item"><p>{{ strftime('%B %Y') }}</p></div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-6">
                        <div class="dashboard-stat color-4">
                            <div class="dashboard-stat-content"><h4>{{$total_contribuables}}</h4> <span>Contribuables</span></div>
                            <div class="dashboard-stat-icon"><i class="im im-icon-Add-UserStar"></i></div>
                            <div class="dashboard-stat-item"><p>Nombre de contribuables</p></div>
                        </div>
                    </div>
