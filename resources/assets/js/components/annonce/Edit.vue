		...
		<template slot="main">
			...
			<div class="row ">
				...
				<div class=" form-group col-4">
					...
					<input type="text" @keypress="numerotel($event)" id="contact2" v-model="editRec.contact" name="contact" placeholder="Contact" class="form-control"><small class="form-text text-muted">Contact Phone</small>
				</div>
			</div>
