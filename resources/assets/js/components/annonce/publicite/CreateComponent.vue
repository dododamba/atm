                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <h6 class='text-default'><span class="important">Contact 2 Du Demandeur</span> <em class="text-light">(saisir)</em></h6>
                                                ...
                                                <input type="text" @keypress="numerotel($event)" id="contact" v-model="contact2" name="contact1" placeholder="contact" class="form-control"><small class="form-text text-muted">saisir le contact</small>
                                            </div>
