                        ...
                        <form @submit.prevent="onSubmit" enctype="multipart/form-data">
                            <template>
                                ...
                                <div class="tab-content" id="myTabContent">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="stat-widget-five">
                                                                    <div class="text-left text-primary stat-icon dib flat-color-1">
                                                                        ...
                                                                        <h6 class='text-default'> <i class="fa fa-btc fa-3x" aria-hidden="true"></i>  <span class="">Cout Correspondant au Forfait</span> <em class="text-light">(Calculer)</em></h6>
                                        ...
                                        <!--div class="row ">
                                         ...
                                         <div class="row ">
                                            ...
                                            <div class=" form-group col-3">
                                                ...
                                                <input type="text" @keypress="numerotel($event)" id="contact2" v-model="contact2" name="contact1" placeholder="contact" class="form-control"><small class="form-text text-muted">saisir le contact</small>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade"  v-bind:class="{active : etape===4,show : etape===4} " id="contact1" role="tabpanel" aria-labelledby="contact-tab1">
                                        <hr>
                                        ...
                                        <div class=" row">
                                            <div class="form-group col-6">
                                                ...
                                                <h6 class=''><span class="count important">Contenue : </span> <em class="text-light">(i)</em>{{this.contenue}}</h6><br/>
                                                <h6 class=''><span class="count important">Date De Debut : </span> <em class="text-light">(i)</em>{{this.dateDebut}}</h6><br/>
