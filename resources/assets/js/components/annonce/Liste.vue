<template>
  <b-card  >
                        ...
                        <thead class="text-uppercase text-primary">
                            ...
                            <tr v-for="record in records.content.data" class="text-center">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-outline-primary btn-sm" title="Edition de l'annonce"   data-toggle="modal" data-target="#editRecord" @click="get(record.slug)"><i class="fa fa-edit"></i></button>

                                    <button class="btn btn-outline-primary btn-sm"  title="Activation de l'annonce"  @click="activation(record.slug)"><i class="fa fa-globe"></i></button>
                                </td>
        ...
        <div id="modal">
            ...
            <edit :editRec="editRec" @recordUpdated="list"></edit>
    ...
    export default {
        ...
        methods: {
            ...
            list(page)
            {
                ...
                axios.get('/api/annonce?page=${page}').then(function(response){
