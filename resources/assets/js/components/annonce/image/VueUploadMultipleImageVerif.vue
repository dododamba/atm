...
<script>
  ...
  export default {
    ...
    props: {
      dragText: {
        type: String,
        default: 'Auccune image selectioner (vous pouvez en ajouter)'
      },
      browseText: {
        type: String,
        default: '(Encore plus en allant au rubrique image <--) '
      },
      primaryText: {
        type: String,
        default: 'Par défaut'
...
<style lang="css">
  .popper-custom .popper__arrow {
    border-color: #034694 transparent transparent transparent !important;
  }
</style>