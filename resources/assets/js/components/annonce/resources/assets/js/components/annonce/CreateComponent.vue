<template>
                            ...
                            <template>
                                ...
                                <ul class="nav  nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="baccouleur nav-item">
                                        <a class="nav-link count text-dark" v-bind:class="{active : etape===1} " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"> Choisir Forfait</a>
                                    </li>
                                    <li class="baccouleur nav-item">
                                        <a class="nav-link count text-dark" v-bind:class="{active : etape===2} " id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Contenue & Contacts</a>
                                    </li>
                                    <li class="baccouleur nav-item">
                                        <a class="nav-link count text-dark" v-bind:class="{active : etape===3} " id="contact-tab" data-toggle="tab" href="#contact11" role="tab" aria-controls="contact11" aria-selected="false">Images</a>
                                    </li>
                                    <li class="baccouleur nav-item count">
                                        <a class="nav-link count text-dark" v-bind:class="{active : etape===4} " id="contact-tab1" data-toggle="tab" href="#contact111" role="tab" aria-controls="contact111" aria-selected="false">Validation</a>
                                    </li>
                                    <li class="baccouleur nav-item count">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade" v-bind:class="{active : etape===1,show : etape===1} " id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            <div class="form-group col-6">
                                                <h6 class='text-default'><span class="important">Date de Debut De L'annonce</span> <em class="text-light">(saisir)</em></h6>
                                                <date-picker
                                                        width="100%"
                                            ...
                                            <div class="form-group col-6">
                                                <h6 class='text-default'><span class="important">Date de Fin de l'annonce</span> <em class="text-light">(saisir)</em></h6>
                                                <date-picker
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-6">
                                                <h6 class='text-default'><span>Type Annonce </span> <em class="text-light">(saisir)</em></h6>
                                            ...
                                            <div  class="form-group col-6">
                                                <h6 class='text-default'><span>Position sur Ecran Disponible</span> <em class="text-light">(saisir)</em></h6>
                                        ...
                                        <div class="row">
                                            <div v-if="type != ''" style="color: midnightblue" class="form-group col-6">
                                                <h6 class='text-default'><span class="">Consuler Nos Forfaits</span> <em class="text-light">(selection)</em></h6>
                                                <h6 class='text-default'><span class="important">Choisir Un Forfait</span> <em class="text-light">(selectionner)</em></h6>
                                    ...
                                    <div class="tab-pane fade"  v-bind:class="{active : etape===2,show : etape===2} " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <!--div class="row ">
                                         ...
                                         <div class="row ">
                                            ...
                                            <div class="form-group col-6">
                                                <h6 class='text-default'><span class="important">Annonceur </span> <em class="text-light">(saisir)</em></h6>
                                             ...
                                             <div class="form-group col-3">
                                              <h6 class='text-default'><span class="important">Contact 1 De L'annonceur</span> <em class="text-light">(saisir)</em></h6>
                                            ...
                                            <div class=" form-group col-3">
                                                <h6 class='text-default'><span class="important">Contact 2 De L'annonceur</span> <em class="text-light">(saisir)</em></h6>
                                        ...
                                        <div class="row">
                                            <div class=" col-12">
                                                ...
                                                <input type="text"  @keypress="empechsaisiebizare($event)" class=" form-control "  v-on:keyup="countdown" id="titre" v-model="titre" name="titre" placeholder="entête de l'annonce" />
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <h6 class='text-default'><span >Le Contenue de l'annonce</span> <em class="text-light">(saisir)</em></h6>
                                    ...
                                    <div class="tab-pane fade"  v-bind:class="{active : etape===3,show : etape===3} "id="contact11" role="tabpanel" aria-labelledby="contact-tab">
                                    ...
                                    <div class="tab-pane fade"  v-bind:class="{active : etape===4,show : etape===4} " id="contact111" role="tabpanel" aria-labelledby="contact-tab1">
                                        <hr>
                                        ...
                                        <div class=" row">
                                            ...
                                            <div class="form-group col-6">
                                                <h6 class=''><span class="count important">Annonceur : </span> <em class="text-light">(i)</em>{{this.annonceur}} </h6><br/>
                                                <h6 class=''><span class="count important">Contact Annonceur : </span> <em class="text-light">(i)</em>{{this.contact}}</h6><br/>
                                                <h6 class=''><span class="count important">Contact2 Annonceur : </span> <em class="text-light">(i)</em>{{this.contact1}}</h6><br/>
 ...
 <button class="btn btn-outline-success btn-block " type="submit">
                                ...
                                <div class="row " v-else>
                                    <div class="col-4" v-if="etape>1 && etape<5">
                                        <button type="button"  class="btn btn-block btn-outline-success pull-left"  v-on:click="etape--"  >
                                            <i class="fa fa-fast-backward fa-1x"></i>
                                            Retour
                                        </button>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            valid_titre() {
                return this.errors.titre == null ? null : false;
            },
            valid_contenue() {
                return this.errors.contenue == null ? null : false;
            },
            valid_dateDebut() {
                return this.errors.dateDebut == null ? null : false;
            },
            valid_dateFin() {
                return this.errors.dateFin == null ? null : false;
            },
            valid_contenue() {
                return this.errors.contact == null ? null : false;
            },
        ...
        methods: {
            ...
            onSubmit() {
                ...
                console.log(new_annonce);

                axios.post('/annonce', new_annonce)
                    .then((response) => {
...
<style scoped>
    ...
    #my-strictly-unique-vue-upload-multiple-imag {
        font-family: 'Avenir', Helvetica, Arial, sans-serif;
        -webkit-font-smoothing: antialiased;
        -moz-osx-font-smoothing: grayscale;
        text-align: center;
