<template>
	...
	<modal-layouts name="editRecord" id="editRecord">
		...
		<template slot="heading">Editer L'annonce</template>
		...
		<template slot="main">
			...
			<div class="form-group">
				...
				<textarea class="form-control" @keydown="delete errors.contenue" v-model="editRec.contenue" v-on:keyup="countdown" id="editRec.contenue" placeholder="Contenue de l'annonce" rows="12"></textarea>
			...
			<div class="row">
				...
				<div class="col-4 form-group text-center ">
					...
					<h6 class='text-center'><span class="important">Statut Annonce : </span> <em class="text-light">(saisir)</em></h6>
			...
			<div class="row ">
				...
				<div class=" form-group col-4">
					<h6 class='text-default'><span class="important">Contact annonceur</span> <em class="text-light"></em></h6>
				...
				<div class=" form-group col-4">
					<h6 class='text-default'><span class="important">Contact annonceur2</span> <em class="text-light"></em></h6>


					<input type="text" @keypress="numerotel($event)" id="contact2" v-model="editRec.contact1" name="contact" placeholder="Contact" class="form-control"><small class="form-text text-muted">Contact Phone2</small>
				</div>
			</div>
