            ...
            <form @submit.prevent="onSubmit" enctype="multipart/form-data">
                <div class="row">
                    <div class="form-group col-12">
                        <label for="taux" class=" form-control-label">Titre</label>
                        <input type="text" id="taux" v-model="taux"
                ...
                <div class="form-group shadow-textarea">
                    ...
                    <textarea class="form-control z-depth-1" v-model="description" id="description" rows="3"
