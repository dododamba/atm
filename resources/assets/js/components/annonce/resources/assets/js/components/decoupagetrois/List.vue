<template>
    ...
    <div>
        ...
        <div class="pull-right"> <b-button  variant="success" @click="_create()">+ Découpage III</b-button></div>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        filter: {
                            type: "simple",
                            placeholder: "decoupage ...."
                        },
                        name: "decoupage_deux", // access nested objects properties with "."
                        sort: true,
                    },
                    {
        ...
        mounted() {
            this._fetch('/api/decoupagetrois?page=0');
        },
        methods: {
            _fetch(url) {
                let _self = this;
                axios.get(url)
                    .then(function (response) {
                        ...
                        _self.items = response.data.content.decoupagetrois;
            ...
            _create(){
                ...
                Swal.fire({
                    title: 'Enregistrement decoupagetrois ',
                    input: 'text',
                    focusConfirm: false,
                    ...
                    if (result.value) {
                        axios.post('/api/decoupagetrois/')
                            .then(function (response) {
                            }).catch(function (response) {
                        });
                        this._fetch('/api/decoupagetrois?page=' + _self.current_page_);
                        Swal.fire(
                            'Succès !',
            ...
            update(item) {
                var _self = this;
                var _decoupagetrois = _self.decoupagetrois;
                _decoupagetrois = item;

                axios.post('/api/update-decoupagetrois', _decoupagetrois)
                    .then(function (response) {
                ...
                this.$refs['edit'].hide();
                this._fetch('/api/decoupagetrois?page=' + this.current_page_);
            }
