    ...
    export default {
            ...
            return {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        name: "titre", // access nested objects properties with "."
                        sort: true,
                    },
                    {
                        ...
                        name: "categorie.nom", // access nested objects properties with "."
                        sort: true,
                    },
                    {
                        ...
                        name: "auteur.nom", // access nested objects properties with "."
                        sort: true,
                    },
                    {
        ...
        methods: {
            ...
            _delete(item) {
                ...
                Swal.fire({
                    title: 'Confirmer la suppression de cet article ',
                    ...
                    if (result.value) {
                        axios.delete('/api/article/' + _slug)
                            .then(function (response) {
                            }).catch(function (response) {
                        });
                        this._fetch('/api/article');
            ...
            _detail(article) {
                ...
                Swal.fire({
                    title: '<strong>Détail Article</strong>',
                    html:
                        '<p><u class="text-success">Titre :</u> ' + article.titre + ' </p>' +
                        '<p><u>Auteur :</u> ' + article.auteur.nom + ' ' + article.auteur.prenom + ' </p>' +

                        '<p><u> Contenu :</u>  </p>' + article.contenu + ' <br>',
