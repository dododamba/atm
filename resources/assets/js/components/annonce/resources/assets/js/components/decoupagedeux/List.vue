<template>
    ...
    <div>
        ...
        <div class="pull-right"> <b-button  variant="success" @click="_create()">+ Découpage II</b-button></div>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        name: "decoupage_un", // access nested objects properties with "."
                        sort: true,
                    },
                    {
        ...
        mounted() {
            this._fetch('/api/decoupagedeux?page=0');
        },
        methods: {
            _fetch(url) {
                let _self = this;
                axios.get(url)
                    .then(function (response) {
                        ...
                        _self.items = response.data.content.decoupagedeux;
            ...
            _create(){
                ...
                Swal.fire({
                    title: 'Enregistrement decoupagedeux ',
                    input: 'text',
                    focusConfirm: false,
                    ...
                    if (result.value) {
                        axios.post('/api/decoupagedeux/')
                            .then(function (response) {
                            }).catch(function (response) {
                        });
                        this._fetch('/api/decoupagedeux?page=' + _self.current_page_);
                        Swal.fire(
                            'Succès !',
            ...
            update(item) {
                var _self = this;
                var _decoupagedeux = _self.decoupagedeux;
                _decoupagedeux = item;

                axios.post('/api/update-decoupagedeux', _decoupagedeux)
                    .then(function (response) {
                ...
                this.$refs['edit'].hide();
                this._fetch('/api/decoupagedeux?page=' + this.current_page_);
            }
