    ...
    export default {
            ...
            return {
                ...
                columns: [
...

                    {
                        ...
                        name: "appreciation", // access nested objects properties with "."
                        sort: true,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        label: "Message",
                        name: "message", // access nested objects properties with "."
                        sort: true,
                    },
                    {

                        label: "Date de création",
                        name: "createrd_at", // access nested objects properties with "."
                        sort: true,
                    },
        ...
        methods: {
            ...
            _delete(item) {
                ...
                Swal.fire({
                    title: 'Confirmer la suppression du like ' + _item.nom,
