<template>
    <div class="row">
                        ...
                        <tr v-for="transaction in items">
                            ...
                            <td class="text-right">
                                <button type="button" rel="tooltip" class="btn btn-danger btn-icon btn-sm "
                                        title="suppression" @click="_delete(transaction)">
        ...
        <template v-if="items == null" class="row">
            <b-alert show variant="danger">Pas de Transaction enregistré pour le moment</b-alert>
        </template>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            _delete(item) {
                ...
                Swal.fire({
                    title: 'Confirmer la suppression du transaction ' + _item.nom,
