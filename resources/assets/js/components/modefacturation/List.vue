            ...
            <div class="single-table">
                <div class="table-responsive">
                    <table class="table table-striped  table-hover text-center">
                        ...
                        <tbody>
                        <tr v-for="modefacturation in items">
                            <td>{{ modefacturation.id }}</td>
                            <td>{{ modefacturation.libelle }}</td>
                            <td></td>
                            <td></td>
                            <td>{{ modefacturation.created_at}}</td>

                            <td class="text-right">
                                <button type="button" rel="tooltip" class="btn btn-danger btn-icon btn-sm "
                                        title="suppression" @click="_delete(modefacturation)">
...
<script>
    ...
    export default {
        ...
        mounted() {
            this._fetch('/api/modefacturations');
        },
        methods: {
            _fetch(url) {
                let _self = this;
