    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            <div class="dashboard-list-box">
                <h4 class="gray"><i class="glyphicon glyphicon-th-list"></i> Communes</h4>
                <div class="table-box">
                    <table class="basic-table booking-table">
                        ...
                        <tr v-for="item in items">
                            ...
                            <td>{{ item.code_commune }}</td>
                            <td>{{ item.responsable_communal.nom }} {{ item.responsable_communal.prenom }}</td>
                            <td>{{ item.hotel.nom_hotel }}</td>
