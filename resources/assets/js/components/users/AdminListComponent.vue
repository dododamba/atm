        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Admin Systeme </h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr v-for="admin in items.data">
                                ...
                                <td>{{ admin.compte.user_role.nom }}</td>

                                <td>
                                    <button v-if="admin.compte.is_active == null " class="btn btn-success"
                                            @click="goToActive(admin)"> Activer
                                    </button>
                                    <button v-else class="btn btn-danger" @click="goToActive(admin)">
                                        Désactiver
                                    </button>
                                </td>
                                <td>{{ admin.compte.last_login}}</td>
                                <td>{{ admin.compte.created_at}}</td>
                                <td class="text-right">
                                    <button type="button" rel="tooltip" class="btn btn-info btn-icon btn-sm "
                                            title="detail" @click="show(admin)">
                                        <i class="fa fa-user"></i>
                                    </button>
                                    <button type="button" rel="tooltip" class="btn btn-success btn-icon btn-sm "
                                            title="mise à jours" @click="edit(admin)">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip" class="btn btn-danger btn-icon btn-sm "
                                            title="suppression" @click="deleteModal(admin.compte.slug)">
                                        <i class="fa fa-times"></i>
                                    </button>
                                    <button type="button" rel="tooltip" class="btn btn-warning btn-icon btn-sm "
                                            title="modification mot de pass" @click="lockModal(admin)">
        ...
        <b-modal ref="create" hide-footer title="Création Compte">
            ...
            <form v-on:submit.prevent="storeModal()">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" v-model="admin.nom">
                </div>
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" v-model="admin.prenom">
                </div>
                ...
                <div class="input-group mb-2">
                    ...
                    <select v-model="admin.sexe" class="form-control">
                ...
                <div class="input-group mb-2">
                    ...
                    <select v-model="admin.langue" class="form-control">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control" v-model="admin.telephone">
                </div>
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="date" class="form-control" v-model="admin.date_naissance">
                </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.list('/api/get-admins?page=0');
        },
        methods: {
            list(url) {
                let app = this;
            ...
            activation(c) {
                let ar = this;
                axios.get('api/admin/activate/' + c.compte.slug)
                    .then(function (response) {
                        ar.message = response.data;
                        ar.success(ar.message.message);
                    });
                this.$refs['activation'].hide();
                this.list('/api/get-admins?page=' + this.current_page_);
            },

            desactivation(c) {
                let ar = this;
                axios.get('api/admin/desactivate/' + c.compte.slug)
                    .then(function (response) {
                        ar.message = response.data;
                        ar.success(ar.message.message);
                    });
            ...
            destroy(slug) {
                let app = this;
                axios.delete('/api/delete-admin/' + slug)
                    .then(function (response) {
            ...
            storeModal() {
                var app = this;
                var newPersonnel = app.admin;
                axios.post('/api/create/admin', newPersonnel)
                    .then(function (response) {
