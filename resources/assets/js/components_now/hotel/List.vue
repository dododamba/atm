    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            <div class="dashboard-list-box">
                <h4 class="gray"><i class="glyphicon glyphicon-th-list"></i> Hotels de ville</h4>
                <div class="table-box">
                    <table class="basic-table booking-table">
                        ...
                        <tr>
                            ...
                            <th>Ville</th>
                            <th>Contact</th>
                            <th>Fonctionnaire Responsable</th>
                            <th>Date d'Ajout</th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        ...
                        <tr v-for="item in items">
                            ...
                            <td>{{ item.ville }}</td>
                            <td>{{ item.contact }}</td>
                            <td>{{ item.employe_responsable.nom }} {{ item.employe_responsable.prenom }}</td>
