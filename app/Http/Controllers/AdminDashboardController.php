...
class AdminDashboardController extends Controller
{
   ...
   public function permission()
   {
    ...
    public function nopermission()
    {
        ...
        /**
     * return publicite pages.
     *
     * @return \Illuminate\Http\Response
     */
    public function publicite()
    {
        return View('annonce.pub');
    }
    ...
    {
        return View('annonce.image.image');
    }
     /**
...
/**
    ...
    {
        return View('annonce.typeannonce.typeannonce');
    }
    /**
     * return clients pages.
     *
    ...
    {
        return View('annonce.tarif.tarif');
    }

    public function position()
    {
        return View('annonce.positionannonce.positionannonce');
    }
...
{
   return View('hotel.chambre');
 
}

public function type_chambre()
{
   return View('hotel.type_chambre');
