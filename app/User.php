...
{
    use PermissibleTrait, Notifiable, AuthenticableTrait, HasApiTokens;
    use SoftDeletes;
    /**
     */
    ...
    {
        return $this->hasMany(Personnel::class, 'user_id');
    }


    public function getPartenaire(Type $var = null)
    {
        return $this->hasMany(Client::class, 'user_id');
    }
     ...
     * @var array
     */
    protected $loginNames = ['matricule'];
    ...
    public function getAffiliateClient()
    {
        return $this->hasOne(Client::class, 'user_id');
    }

    public function getAffiliateAdmin()
    {
        return $this->hasOne(Admin::class, 'user_id');
    }

    public function getAffiliatePersonnel()
    {
        return $this->hasOne(Personnel::class, 'user_id');
    }

    public function getAffiliatePartenaire()
    {
        return $this->hasOne(Partenaire::class, 'user_id');
    }
